    ...
    >
      <div className="portfolio-page contact-page">
        ...
        <div className="row1">
          ...
          <div className=" row-item Amazon">
            <div className="row-text">
              <h2 className="child">Amazon clone </h2>
              <p>With React JS</p>
              <h3>Project Source</h3>
              <div className="source">
                <a
                  href="https://github.com/janoth123/Amazon-clone.git"
                  target="blank"
                >
                  <div className="icon">
                    <FaGithub /> 
          ...
          <div className=" row-item row-item2">
            <div className="row-text">
              <h2 className="child">Bank App </h2>
              <p>With ReactJs, Typescript</p>
              <h3>Project Source</h3>

              <div className="source">
                <a href="https://github.com/janoth123/lendsqr-clone-app.git" target="blank">
                  <div className="icon">
                    <FaGithub />
                  </div>
                </a>

                <a href="https://samuel-jonathan-onoja-lendsqr-fe-test.netlify.app/" target="blank">
                  <div className="icon">
                    <FaChrome />
                  </div>
                </a>
          ...
          <div className=" row-item row-item4">
            <div className="row-text">
              ...
              <h3>Project Source</h3>
              <div className="source">
                <a href="https://github.com/janoth123/Scholarship-Exam-For-Schools.git" target="blank">
                  <div className="icon">
                    <FaGithub />
                  </div>
                </a>
          ...
          <div className=" row-ite row-item-more">
            ...
            <div className="more-row-text">
              ...
              <div className="source">
                <a
                  href="https://github.com/janoth123"
                  target="blank"
                >
                  <div className="icon">
                    <FaGithub />
